...
class Pextension extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'fec_desde' => Yii::t('app', 'Fecha de Inicio'),
            'fec_hasta' => Yii::t('app', 'Fecha de Fin'),
            ...
            'ord_priori' => Yii::t('app', 'Orden Prioridad'),
            'fec_carga' => Yii::t('app', 'Fecha de Carga'),
        ];
    }
